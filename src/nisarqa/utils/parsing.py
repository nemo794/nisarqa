...
def parse_cli_args(nisar_product):
    ...
    nisar_product = nisar_product.upper()
    if nisar_product in ('RSLC', 'RUNW', 'RIFG', 'ROFF'):
        xml_default = './xml/nisar_L1_%s.xml' % nisar_product
    else:
        xml_default = './xml/nisar_L2_%s.xml' % nisar_product
