...
class UNWSwathImage(GUNWAbstractImage):
    ...
    def read(self, handle, xstep=1, ystep=1):
        ...
        self.phase_unwrapped = handle["unwrappedPhase"][::xstep, ::ystep]
