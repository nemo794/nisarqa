...
setup(name = "quality",
    ...
    packages = ["quality"],
    test_suite = "test",
    scripts=['verify_rslc.py', 'verify_gslc.py', 'verify_gcov.py', 'verify_gunw.py', 'verify_runw.py'],
    data_files=[('EGG-INFO/scripts/xml', ['xml/nisar_L0B_RSD.xml']),
                ('EGG-INFO/scripts/xml', ['xml/nisar_L1_COV.xml']),
                ('EGG-INFO/scripts/xml', ['xml/nisar_L1_RIFG.xml']),
                ('EGG-INFO/scripts/xml', ['xml/nisar_L1_MLD.xml']),
                ('EGG-INFO/scripts/xml', ['xml/nisar_L1_RSLC.xml']),
                ('EGG-INFO/scripts/xml', ['xml/nisar_L1_RUNW.xml']),
