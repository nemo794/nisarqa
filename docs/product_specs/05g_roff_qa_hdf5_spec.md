...
Each QA HDF5 file includes a subset of the available options below, which will correspond to the available frequencies, polarizations, etc. in the input ROFF granule.
...
|     | ROFF QA HDF5 Datasets, Attributes, and Additional Metadata |
| :---: | --------------------------------------- |
...
|    | _title:_ NISAR Quality Assurance Statistical Summary of ROFF HDF5 Product |
|     |     |    |
| Path | **`science/LSAR/QA/data/frequencyA/listOfPolarizations`** |
|    | ROFF QA dataset, **ndim:** 1-D array, **dtype:** fixed-length byte string |
...
|    | ROFF QA dataset, **ndim:** 1-D array, **dtype:** float32 |
...
|    | ROFF QA dataset, **ndim:** 1-D array, **dtype:** float64 |
...
|    | ROFF QA dataset, **ndim:** scalar, **dtype:** float32 |
...
|    | ROFF QA dataset, **ndim:** scalar, **dtype:** float64 |
...
|    | ROFF QA dataset, **ndim:** scalar, **dtype:** fixed-length byte string |
...
|    | ROFF QA dataset, **ndim:** 1-D array, **dtype:** int64 |
...
|    | ROFF QA dataset, **ndim:** scalar, **dtype:** uint8 |
...
|    | ROFF QA dataset, **ndim:** scalar, **dtype:** uint16 |
...
|    | ROFF QA dataset, **ndim:** scalar, **dtype:** uint32 |
