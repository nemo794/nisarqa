...
def test_multilook_unequal_nlook1():
    ...
    expected_out = np.array([[5, 8], [17, 20]])
...
def test_multilook_unequal_nlook2():
    ...
    expected_out = np.array([[4, 5, 6, 7, 8, 9], [16, 17, 18, 19, 20, 21]])
...
def test_multilook_uneven_nlook_axis1():
    ...
    expected_out = np.array([[5.5], [17.5]])
...
def test_multilook_zeros():
    ...
    expected_out = np.array([[5, 8], [14.5, 20]])
...
def test_multilook_nans():
    ...
    expected_out = np.array([[5, 8], [np.nan, 20]])
